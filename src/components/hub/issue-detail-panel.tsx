...
// Linear's logo mark, rendered in currentColor so it inherits the button's
// muted/hover treatment like the lucide icons beside it.
function LinearGlyph({ className }: { className?: string }) {
  return (
